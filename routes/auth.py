...
auth_bp.add_url_rule("/forgot", view_func=auth_views.forgot_password, methods = ["GET", "POST"])
auth_bp.add_url_rule("/reset", view_func=auth_views.reset_password, methods = ["GET", "POST"])